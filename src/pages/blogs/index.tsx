...
const Blogs: NextPage<Props> = ({ posts }) => {
  return (
    <>
      <NextSeo
        title='Blog | Thom McCarthy'
        description='Exploring web development and design, I craft functional and accessible experiences. Occasionally, I write about my latest learnings, reinforcing and sharing knowledge.'
        canonical='https://thommccarthy.com/blogs'
      />
      <div className='p-5'>
        ...
        <div
          className='backgroundGlass font-bold text-xl mx-auto flex justify-center py-4 md:py-6 px-5 mt-5 mb-10 rounded-lg max-w-3xl border-2 border-sky-300  hover:bottom-10
        ...
        <RainbowDivider />
        <ul className='max-w-5xl flex flex-col mx-auto py-3 md:py-5 mb-14 gap-4'>
          {posts.map((post) => (
            <li key={post.slug}>
              <BlogCard
                title={post.title}
