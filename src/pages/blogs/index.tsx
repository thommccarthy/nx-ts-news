...
const Blogs: NextPage<Props> = ({ posts }) => {
  return (
    <div className='p-5'>
      ...
      <div
        className='backgroundGlass font-bold text-xl mx-auto flex justify-center py-4 md:py-6 px-7 mt-5 mb-14 rounded-lg max-w-3xl border-2 border-sky-300  hover:bottom-10
